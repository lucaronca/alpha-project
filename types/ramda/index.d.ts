...
declare module 'ramda' {
  ...
  interface Static {
    ...
    pipeP<V0, V1, T1, T2, T3>(
      fn0: (x0: V0, x1: V1) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
    ): (x0: V0, x1: V1) => Promise<T3>
    pipeP<V0, V1, V2, T1, T2, T3>(
      fn0: (x0: V0, x1: V1, x2: V2) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
    ...
    pipeP<V0, V1, T1, T2, T3, T4>(
      fn0: (x0: V0, x1: V1) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
    ): (x0: V0, x1: V1) => Promise<T4>
    pipeP<V0, V1, V2, T1, T2, T3, T4>(
      fn0: (x0: V0, x1: V1, x2: V2) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
    ...
    pipeP<V0, V1, V2, T1, T2, T3, T4, T5, T6>(
      fn0: (x0: V0, x1: V1, x2: V2) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
    ...
    pipeP<V0, V1, T1, T2, T3, T4, T5, T6, T7>(
      fn0: (x0: V0, x1: V1) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
    ...
    pipeP<V0, V1, V2, T1, T2, T3, T4, T5, T6, T7>(
      fn0: (x0: V0, x1: V1, x2: V2) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
    ...
    pipeP<V0, V1, T1, T2, T3, T4, T5, T6, T7, T8>(
      fn0: (x0: V0, x1: V1) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
      ...
      fn6: (x: T5) => Promise<T6>,
      fn7: (x: T7) => Promise<T8>,
    ): (x0: V0, x1: V1) => Promise<T8>
    pipeP<V0, V1, V2, T1, T2, T3, T4, T5, T6, T7, T8>(
      fn0: (x0: V0, x1: V1, x2: V2) => Promise<T1>,
      fn1: (x: T1) => Promise<T2>,
      fn2: (x: T2) => Promise<T3>,
      fn3: (x: T3) => Promise<T4>,
